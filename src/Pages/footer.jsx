...
const Footer = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const message = encodeURIComponent(
      `Hello! I am interested. My phone number is: ${phone}`
    );
      ...
      <div className="footer-container">
        <div className="footer-grid">
          ...
          <div className="footer-column company-info">
            <img
              src={hpsLogo}
              alt="HPS Construction Logo"
              className="footer-logo"
              onClick={handleScrollToTop}
            />
            <p className="company-description">
              Your trusted B2B partner for premium bamboo, POP, ropes, and a
              full range of construction materials. We build futures,
              sustainably.
            </p>
            <div className="social-links">
              <a
                href="mailto:haripalsingh2580@gmail.com"
                title="Email Us"
              ...
              <a
                href="https://www.instagram.com/thakur__abhiraj_singh/"
                title="Instagram"
                target="_blank"
                rel="noopener noreferrer"
                className="social-icon"
          ...
          <div className="footer-column quick-links">
            ...
            <ul className="footer-links">
              ...
              <li>
                {/* <a href="/about" onClick={handleScrollToBottom}>
                  About Us
                </a> */}
          ...
          <div className="footer-column newsletter-section">
            ...
            <p>
              Get exclusive access to industry insights, new product launches,
              and special offers.
            </p>
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-content">
            <div className="copyright-section">
              <p>
                © {new Date().getFullYear()} HPS Construction. All Rights
                Reserved.
              </p>
            </div>
