...
const QueryForm = () => {
  ...
  useEffect(() => {
    ...
    console.log(
      "🔑 QueryForm EmailJS initialized with:",
      import.meta.env.VITE_EMAILJS_QUERY_PUBLIC_KEY
    );
  ...
  const sendEmailAndWhatsApp = async () => {
    try {
      ...
      console.log(
        "🔑 Using Query Service ID:",
        import.meta.env.VITE_EMAILJS_QUERY_SERVICE_ID
      );
      console.log(
        "🔑 Using Query Template ID:",
...
Please contact me for bamboo and POP services.`
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (emailSuccess) {
        alert(
          "✅ Your message has been sent successfully via Email & WhatsApp! We'll contact you soon."
        );
        closeModal();
      } else {
        alert(
            ...
            <div className="query-modal-content">
              <form className="query-form" onSubmit={handleSubmit}>
                ...
                <button
                  ...
                  disabled={isSubmitting}
                >
                  {isSubmitting ? "📝 Saving Details…" : "Cancel"}
                </button>
              </form>
            </div>
          </div>
